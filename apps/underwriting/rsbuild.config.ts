...
export default defineConfig({
  ...
  plugins: [
    ...
    pluginModuleFederation({
      ...
      // http://localhost:3002 for standalone dev. When loaded via the shell,
      // the singleton check at runtime makes the remote reuse the shell's
      // copies — its own bundled versions are never instantiated.
      shared: {
